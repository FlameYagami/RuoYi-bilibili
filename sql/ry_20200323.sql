...
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(100,  0,   '0',          '智能无限', 0, '', '', '', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(101,  100, '0,100',      '南昌总部', 1, '', '', '', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(102,  100, '0,100',      '深圳分部', 2, '', '', '', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(103,  101, '0,100,101',  '研发部',   1, '', '', '', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(104,  101, '0,100,101',  '市场部',   2, '', '', '', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(105,  101, '0,100,101',  '运营部',   3, '', '', '', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(106,  101, '0,100,101',  '财务部',   4, '', '', '', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(107,  101, '0,100,101',  '人事行政部',   5, '', '', '', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(108,  102, '0,100,102',  '研发部',   1, '', '', '', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(109,  102, '0,100,102',  '财务部',   2, '', '', '', '0', '0', 'admin', sysdate(), '', null);
...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1,  103, 'admin', '管理员', '00', '', '', '0', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', sysdate(), sysdate(), 'admin', sysdate(), '', null, '管理员');
...
insert into sys_post values(2, 'vp', '副总经理',    2, '0', 'admin', sysdate(), '', null, '');
insert into sys_post values(3, 'od', '运营总监',    3, '0', 'admin', sysdate(), '', null, '');
insert into sys_post values(4, 'pm',   '项目经理',  4, '0', 'admin', sysdate(), '', null, '');
insert into sys_post values(5, 'hrm',  '人事经理',  5, '0', 'admin', sysdate(), '', null, '');
